...
const steps = [
  step(
    ...
    "additive-bucket-source-missing",
    {
      ...
      bucketSourceTermsAssessment: additiveBucketSource?.summary?.bucketSourceTermsAssessment ?? null,
      bucketSourceTermHits: additiveBucketSource?.summary?.bucketSourceTermHits ?? null,
      bucketSourceCandidateHits: additiveBucketSource?.summary?.bucketSourceCandidateHits ?? null,
      bucketSourceNearWatchedHits: additiveBucketSource?.summary?.bucketSourceNearWatchedHits ?? null,
      bucketSourceBonusPercentHits: additiveBucketSource?.summary?.bucketSourceBonusPercentHits ?? null,
      binaryTableSourceAssessment: additiveBucketSource?.summary?.binaryTableSourceAssessment ?? null,
      binaryTableSourceFilesScanned: additiveBucketSource?.summary?.binaryTableSourceFilesScanned ?? null,
      binaryTableExactHits: additiveBucketSource?.summary?.binaryTableExactHits ?? null,
      binaryTableUsefulHits: additiveBucketSource?.summary?.binaryTableUsefulHits ?? null,
      binaryTableSourceCandidates: additiveBucketSource?.summary?.binaryTableSourceCandidates ?? null,
      sourceConclusionAssessment: additiveBucketSource?.summary?.sourceConclusionAssessment ?? null,
      localSourceEvidenceExhausted: additiveBucketSource?.summary?.localSourceEvidenceExhausted === true,
      sourceConclusionBlockedProbes: additiveBucketSource?.summary?.sourceConclusionBlockedProbes ?? null,
